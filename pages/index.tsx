  ...
  return (
    <>
      <div className='h-screen w-screen bgLanding flex justify-center items-center flex-wrap flex-col md:flex-row content-center gap-y-4 md:gap-y-8 gap-x-10'>
        ...
        <a href="/Atelier" className="text-center order-3 outline outline-1 text-xl px-3 py-1 w-52 hover:bg-white hover:bg-opacity-50">Atelier</a>
        <a href="/Siebdruck" className="text-center order-3 outline outline-1 text-xl px-3 py-1 w-52 hover:bg-white hover:bg-opacity-50">Siebdruck</a>
        <a href="/Requisitenbau" className="text-center order-3 outline outline-1 text-xl px-3 py-1 w-52 hover:bg-white hover:bg-opacity-50">Requisitenbau</a>
